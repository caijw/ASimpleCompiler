...
var literalNames = [ null, "'Number'", "'='", "'*='", "'/='", "'%='", "'+='", 
                     "'-='", "'<<='", "'>>='", "'>>>='", "'&='", "'^='", 
                     "'|='", "'{'", "'}'", "'int'", null, "'('", "')'", 
                     "';'", "','", "'+'", "'-'", "'*'", "'/'", "'%'" ];

var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, "INT", "IntegerLiteral", 
                      "LPAREN", "RPAREN", "SEMI", "COMMA", "ADD", "SUB", 
                      "MUL", "DIV", "MOD", "Identifier", "WS", "COMMENT", 
                      "LINE_COMMENT" ];
...
PlayScriptParser.T__3 = 4;
PlayScriptParser.T__4 = 5;
PlayScriptParser.T__5 = 6;
PlayScriptParser.T__6 = 7;
PlayScriptParser.T__7 = 8;
PlayScriptParser.T__8 = 9;
PlayScriptParser.T__9 = 10;
PlayScriptParser.T__10 = 11;
PlayScriptParser.T__11 = 12;
PlayScriptParser.T__12 = 13;
PlayScriptParser.T__13 = 14;
PlayScriptParser.T__14 = 15;
PlayScriptParser.INT = 16;
PlayScriptParser.IntegerLiteral = 17;
PlayScriptParser.LPAREN = 18;
PlayScriptParser.RPAREN = 19;
PlayScriptParser.SEMI = 20;
PlayScriptParser.COMMA = 21;
PlayScriptParser.ADD = 22;
PlayScriptParser.SUB = 23;
PlayScriptParser.MUL = 24;
PlayScriptParser.DIV = 25;
PlayScriptParser.MOD = 26;
PlayScriptParser.Identifier = 27;
PlayScriptParser.WS = 28;
PlayScriptParser.COMMENT = 29;
PlayScriptParser.LINE_COMMENT = 30;
...
PlayScriptParser.prototype.primitiveType = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 34;
        this.match(PlayScriptParser.T__0);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
PlayScriptParser.prototype.expressionStatement = function() {
    ...
    try {
        ...
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlayScriptParser.IntegerLiteral) | (1 << PlayScriptParser.LPAREN) | (1 << PlayScriptParser.Identifier))) !== 0)) {
            this.state = 40;
            this.expression(0);
        }
...
PlayScriptParser.prototype.assignmentOperator = function() {
    ...
    try {
        ...
        this.state = 75;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlayScriptParser.T__1) | (1 << PlayScriptParser.T__2) | (1 << PlayScriptParser.T__3) | (1 << PlayScriptParser.T__4) | (1 << PlayScriptParser.T__5) | (1 << PlayScriptParser.T__6) | (1 << PlayScriptParser.T__7) | (1 << PlayScriptParser.T__8) | (1 << PlayScriptParser.T__9) | (1 << PlayScriptParser.T__10) | (1 << PlayScriptParser.T__11) | (1 << PlayScriptParser.T__12))) !== 0))) {
...
PlayScriptParser.prototype.compoundStatement = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 133;
        this.match(PlayScriptParser.T__13);
        this.state = 135;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlayScriptParser.T__0) | (1 << PlayScriptParser.T__13) | (1 << PlayScriptParser.IntegerLiteral) | (1 << PlayScriptParser.LPAREN) | (1 << PlayScriptParser.SEMI) | (1 << PlayScriptParser.Identifier))) !== 0)) {
            this.state = 134;
            this.blockItemList(0);
        }

        this.state = 137;
        this.match(PlayScriptParser.T__14);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
